...
public class DateFormaterTest {
    ...
    public void convertStringToDate_validString_shouldParseToDate() {
        ...
        Assert.assertEquals("Probando que se obtenga un objeto date con la fecha en string", date.getTime(), DateFormater.convertStringToDate("01/01/2020").getTime());
    }
    ...
    public void convertDateToString_validDate_shouldParseToString() {
        ...
        cal.set(2020, 0, 1);
        Date date = cal.getTime();
        Assert.assertEquals("Probando que no se obtenga null despues de realizar un cast", "01/01/2020", DateFormater.convertDateToString(date));
    }
