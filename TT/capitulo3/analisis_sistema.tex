...
\input{capitulo3/requerimientos}

\input{capitulo3/reglas-negocio}
\section{Análisis de Riesgos}
\input{capitulo3/riesgos.tex}
\newpage   
\section{Descripción del software}
\input{capitulo3/android}
\input{capitulo3/base.tex}
\input{capitulo3/framework.tex}
\input{capitulo3/solucion.tex}
\input{capitulo3/conjunto_expresiones.tex}