...
\section{Análisis de Imágenes}\label{imAnalysis}
        ...
        \subsection{Realce de la imagen}
			...
			\begin{equation}
				s = T(r)
			\end{equation}
			donde por simplicidad de notación, $r$ y $s$ son variables denotando respectivamente el nivel de gris de $f(x,y)$ y $g(x,y)$ en cualquier punto $(x,y)$. Por ejemplo, si $T(r)$ tiene la forma mostrada en %refIm
